...
const NewsComponent: React.FC = () => {
        ...
        const fetchNews = async () => {
            try {
                const response = await fetch(
                    "https://localhost:7101/api/articles"
                ); // Изменён путь к API
    ...
    return (
        <div className="news-container">
            <h2>
                Today in the <span className="highlight">news</span>
            </h2>
                ...
                {featuredNews.length > 0 && (
                    <div className="featured-news">
                        <BigNews
                            ...
                            ).toLocaleTimeString()} // Преобразуем createdAt в time
                            date={new Date(
                                featuredNews[0].createdAt
                            ).toLocaleDateString()} // Преобразуем createdAt в дату
                        />
                    </div>
                )}
            ...
            <h2>
                And more <span className="highlight">News</span>
            </h2>
